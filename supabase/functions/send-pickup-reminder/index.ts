...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('Received reminder request:', { ...requestBody, email: requestBody.email ? 'provided' : 'missing' })
    ...
    const dateInfo = pickupDate ? formatDate(pickupDate) : { dayOfWeek: 'Tomorrow', fullDate: 'Date to be confirmed' }
...
<head>
  ...
  <div style="display:none;font-size:1px;color:#333333;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
    Tomorrow is your scheduled donation pickup! Please have your items bagged or boxed and ready by 8:00 AM. Remember to check our accepted items list.
  </div>
...
<body style="margin: 0; padding: 0; width: 100%; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica', 'Arial', sans-serif;">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mainTable" style="background-color: #F0F0F0;">
                ...
                <tr>
                  <td valign="top" align="left">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left">
                          <span class="h1 textColorDark" style="font-weight: 700; font-size: 28px; line-height: 34px; color: #0a0e27;">Pickup Reminder</span>
                        </td>
                      </tr>
                      <tr class="spacer">
                ...
                <tr>
                  <td align="left" class="message" valign="top" style="background-color: #f0fdf4; padding: 18px; border-left: 4px solid #14532d; border-radius: 4px;">
                    <div class="textSmall textColorNormal" style="font-size: 14px; line-height: 20px; color: #4f4f65;">
                      <span class="text-bold textColorDark" style="font-weight: 600; color: #0a0e27;">Your pickup is scheduled for tomorrow!</span>
                      <br /><br />
                      This is a friendly reminder that our team will be arriving tomorrow to collect your donation items. Please ensure your items are ready for pickup.
                    </div>
                  </td>
                </tr>
                <tr class="spacer">
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td align="left" valign="middle" width="468">
                          <div class="textSmall textColorNormal" style="font-size: 14px; line-height: 20px; color: #4f4f65;">
                            <span class="text-bold textColorDark" style="font-weight: 600; color: #0a0e27;"><span style="display: inline-block; width: 20px;">📅</span> Tomorrow - {{dayOfWeek}}, {{fullDate}}</span>
                            <br />
                      ...
                      <tr>
                        <td align="left">
                          <div class="textSmall textColorNormal mt1" style="margin-top: 12px; font-size: 14px; line-height: 22px; color: #4f4f65; white-space: nowrap;">
                            • Have your items bagged or boxed<br />
                            • Place items in a visible, accessible location<br />
                            • Ensure items are ready by 8:00 AM<br />
                            • No need to be home - leave items outside<br />
                            • <strong>Reminder:</strong> Check our <a href="https://www.hhdonations.com/what-to-donate" style="color: #14532d; text-decoration: underline;">accepted items list</a><br />
                ...
                <tr>
                  <td valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td align="left">
                          <div class="textSmall textColorNormal mt1" style="margin-top: 12px; font-size: 14px; line-height: 22px; color: #4f4f65;">
                            {{specialInstructions}}
                          </div>
                        </td>
                      </tr>
    ...
    const finalHtml = emailHtmlTemplate
      .replace(/{{dayOfWeek}}/g, dateInfo.dayOfWeek)
      .replace(/{{fullDate}}/g, dateInfo.fullDate)
      .replace(/{{address}}/g, address || 'Address not provided')
      .replace(/{{#if specialInstructions}}[\s\S]*?{{\/if}}/g, specialInstructions ? 
        emailHtmlTemplate.match(/{{#if specialInstructions}}([\s\S]*?){{\/if}}/)?.[1]
          ?.replace(/{{specialInstructions}}/g, specialInstructions) || '' : '')
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: email,
        subject: `Reminder: Donation Pickup Tomorrow - ${dateInfo.dayOfWeek}`,
        html: finalHtml,
      }),
    })
