...
const RequestPickup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.phone || !formData.address || !selectedDate || !formData.time) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="bg-white rounded-lg p-6 shadow-sm border text-left">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div><strong>Pickup Time:</strong> {formData.time}</div>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                <div>
                  ...
                  <p className="text-gray-600">Complete the pickup request form below with your contact details and preferred schedule.</p>
                </div>
                <div>
                ...
                <div>
                  <div className="font-semibold text-primary mb-2">3. Pickup</div>
                  <p className="text-gray-600">Our team will arrive during your scheduled time window to collect your donations.</p>
                </div>
              </div>
            </CardContent>
          </Card>
