...
import { Heart, Users, Recycle, Shield, LayoutDashboard } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className={`space-y-2 ${!openSections.includes('quicklinks') ? 'hidden sm:block' : ''}`}>
              ...
              <li><a href="/request-pickup" className="text-sm sm:text-base text-gray-600 hover:text-gray-900 transition-colors inline-block py-1">Request Pickup</a></li>
          ...
          <div className="text-center sm:text-left">
            ...
            {/* Desktop header */}
            <h4 className="hidden sm:block font-semibold text-base sm:text-lg mb-3 sm:mb-4">Resources</h4>
            {/* Content - hidden on mobile unless expanded */}
            <ul className={`space-y-2 ${!openSections.includes('resources') ? 'hidden sm:block' : ''}`}>
              <li><a href="/contact" className="text-sm sm:text-base text-gray-600 hover:text-gray-900 transition-colors inline-block py-1">Contact Us</a></li>
